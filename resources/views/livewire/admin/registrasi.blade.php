...
{{-- A good traveler has no fixed plans and is not intent upon arriving. --}}
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            ...
            <div class="me-4">
                <a href="admin/login" class="btn text-dark rounded-pill fw-semibold">Masuk</a>
            </div>
        </div>
      </nav>
              ...
              <div class="mb-2">
                <h3 class="text-center mt-3">Registrasi</h3>
                  <div class="mb-2"> 
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan NIPP Anda">
                  </div>
                  <div class="mb-2">
