                            ...
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                                ...
                                <li class="">
                                    ...
                                    @if (auth('admin-web')->user()->role == 'admin')
                                        <a href="{{ url('admin/user-kai') }}"
                                            class="nav-link px-0 align-middle text-white text-decoration-none bi bi-person-fill-gear">
                                            <span class="d-none d-sm-inline">Manage User</span></a>
                                    @endif
                                </li>
                            </ul>
                        </div>
